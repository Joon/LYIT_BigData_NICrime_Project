...
# (coords from the Irish Grid system) converted to Longitude and Latitude.
...
coords <- cbind(X_coord = as.numeric(as.character(clean_ni_postcode_data$x_coordinates)), 
                y_coord = as.numeric(as.character(clean_ni_postcode_data$y_coordinates)))
